         ...
         {data.milestones.map(milestone => {
           ...
           return (
             <div key={milestone.id} className="relative bg-white/5 p-5 rounded-2xl border border-white/5 overflow-hidden group">
               ...
               <h4 className="text-white font-semibold text-lg truncate relative z-10">{milestone.name}</h4>
               <div className="flex justify-between items-end mt-2 relative z-10">
                 ...
                 <span className="text-xl font-bold" style={{ color: milestone.color }}>{percent.toFixed(0)}%</span>
               </div>
             </div>
           )
         })}
